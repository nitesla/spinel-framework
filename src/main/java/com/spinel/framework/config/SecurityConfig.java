    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.
                ...
                "/public/**", "/favicon.ico", "/pub/**",
                        ...
                        "/api/v1/agent/resendotp","/api/v1/agent/activateUser","/api/v1/ping/check","/api/v1/user/resendotp",
                        ...
                        "/api/v1/organisationtype/active/list", "/api/v1/projectowner/signup", "/api/v1/projectowner/completesignup",
                        "/api/v1/enumerator/completesignup", "/api/v1/enumerator/signup", "/api/v1/enumerator/passwordactivation", "/api/v1/enumerator/validateOtp",
                        "/api/v1/projectowner/validateOtp", "/api/v1/authenticate/adminlogin", "/api/v1/projectowner/passwordactivation",
